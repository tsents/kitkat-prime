...
const unsigned long long SMALL_NUMBER = 10000;

/**
 * Checks if (num) is prime. choses method based
 * on the number's size.
 */
bool checkPrime(unsigned long long num);

/**
 * Calculates if (num) is prime using the simple
 * method if iteretivly trying %.
 */
